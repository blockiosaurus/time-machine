...
export const characters = pgTable(
  'characters',
  {
    ...
    portraitContentType: text('portrait_content_type').default('image/png'),
    promptIpfsCid: text('prompt_ipfs_cid').default(''),
    portraitIpfsCid: text('portrait_ipfs_cid').default(''),
    registrationIpfsCid: text('registration_ipfs_cid').default(''),
